...
export const BackendURL = () => (
	<div className="mt-5 pt-5 w-50 mx-auto">
		...
		<p>There&apos;s one variable called <Dark>VITE_BACKEND_URL</Dark> that needs to be manually set by yourself.</p>
		<ol>
		...
		<div className="w-100">
			<img src={envFile} className="w-100" alt="Example env file configuration" />
		</div>
